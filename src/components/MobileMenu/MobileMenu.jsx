...
export const MobileMenuItem = ({ className, title, accountItem, user, toggleMenu }) => {
    ...
    >
      ...
      {user ? 
        ...
        <div className="account-menu-items guest">
          <button onClick={navigateToSignUp}><span><FontAwesomeIcon icon={faUserPlus} /></span>Sign Up</button>
          <button onClick={navigateToSignIn}><span><FontAwesomeIcon icon={faUser} /></span>Sign In</button>
        </div>
      }
    </article>
  ) : (
